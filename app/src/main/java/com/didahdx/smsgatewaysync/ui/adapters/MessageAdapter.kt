...
import com.didahdx.smsgatewaysync.ui.adapters.MessageAdapter.MessageViewHolder.Companion.from

class MessageAdapter(val clickListener: MessageAdapterListener) :
    ListAdapter<MpesaMessageInfo, MessageAdapter.MessageViewHolder>(MessageAdapterDiffCallback()) {
