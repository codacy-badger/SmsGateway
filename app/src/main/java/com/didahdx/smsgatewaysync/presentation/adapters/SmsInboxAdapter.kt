package com.didahdx.smsgatewaysync.presentation.adapters
...
import com.didahdx.smsgatewaysync.presentation.adapters.SmsInboxAdapter.SmsInboxViewHolder.Companion.from


class SmsInboxAdapter(private val clickListener: SmsInboxAdapterListener) :
    ListAdapter<SmsInboxInfo, SmsInboxAdapter.SmsInboxViewHolder>(SmsInboxAdapterDiffCallback()) {
...
//            binding.clickListener = clickListener
        ...
        companion object {
            fun from(parent: ViewGroup): SmsInboxViewHolder {
                ...
                return SmsInboxViewHolder(binding)
            }
        }
    }
