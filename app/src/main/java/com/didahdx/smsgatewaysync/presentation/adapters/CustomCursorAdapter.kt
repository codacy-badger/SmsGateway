...
abstract class CustomCursorAdapter<V : RecyclerView.ViewHolder?>(c: Cursor?) :
    ...
    override fun onBindViewHolder(holder: V, position: Int) {
        ...
        mCursor?.moveToPosition(position)
            ?.let { check(it) { "Could not move cursor to position $position when trying to bind view holder" } }
