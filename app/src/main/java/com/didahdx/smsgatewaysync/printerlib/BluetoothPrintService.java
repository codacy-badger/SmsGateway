package com.didahdx.smsgatewaysync.printerlib;
...
public class BluetoothPrintService {
    ...
    public synchronized void connect(BluetoothDevice device, boolean secure) {
        if (D) Timber.d("connect to: %s", device);
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device, final String socketType) {
        if (D) Timber.d("connected, Socket Type:%s", socketType);
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device, boolean secure) {
            ...
            try {
                ...
                Timber.e(e, "Socket Type: " + mSocketType + "create() failed");
            }
            mmSocket = tmp;
        }
        
        public void run() {
            Timber.i("BEGIN mConnectThread SocketType:%s", mSocketType);
            ...
            try {
                ...
                try {
                    ...
                    Timber.e(e2, "unable to close() " + mSocketType + " socket during connection failure");
                }
        ...
        public void cancel() {
            try {
                ...
                Timber.e(e, "close() of connect " + mSocketType + " socket failed");
            }
        }
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket, String socketType) {
            Timber.d("create ConnectedThread: %s", socketType);
            mmSocket = socket;
